...
# ===== Plot locations of Annotated CACTA_TIR transposons =====
...
ggplot(Dxy_TEs[hap == 'h'] ) + 
  ...
  # NDR1
  ##annotate("rect", xmin = 31879698,
  #         xmax = 31880287, 
  #         ymin=0, 
  #         ymax = 0.3, 
  #         alpha = .3,fill = 'maroon')  +
  #annotate("rect", xmin = 31880286,
  #         xmax = 31882134, 
  #        ymin=0, 
  #         ymax = 0.3, 
  #         alpha = .3,fill = 'blue')   #+
...
# ===== Plot Divergence against hJcaliAlt =====
...
plot2 <- ggplot(DxyhJmanSub, aes(x = window, y = Dxy, group = qryGnom) ) + 
  #facet_wrap(~species) +
  #geom_point()  +
